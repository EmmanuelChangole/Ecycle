...
public class WhyEwaste extends AppCompatActivity {
    ...
    private void initView() {
        ...
        int images[] = {R.drawable.ewaste_typs, R.drawable.ic_electronic_waste, R.drawable.go_greenlife,R.drawable.waste_recycle};
