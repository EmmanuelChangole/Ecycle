...
public class WasteAccumulation extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_content_);
    ...
    {
         int[] imageAddresss={R.drawable.accumulated,R.drawable.african_accumlated,R.drawable.ecopace,R.drawable.waste_recycle};

        SliderView sliderView = findViewById(R.id.imageSlider);

        SliderAdapterExample adapter = new SliderAdapterExample(this);
        adapter.initAddress(imageAddresss);
